...
date:       2019-7-31			   	# 时间
author:     Cc1over				# 作者
header-img: img/post-bg-mma-4                #这篇文章标题背景图片
catalog: true 						# 是否归档
tags:								#标签
    - apk学习系列
---
...
* **walle及vaslloy：** 美团多渠道打包方案和腾讯的多渠道打包方案其实在V1签名的处理上有所差异，美团是添加空文件，vaslloy是添加zipcomment，v2签名就就往signing block里添加id-value的数据
